System.register(['angular2/core', './course.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            CoursesComponents = (function () {
                function CoursesComponents(courseService) {
                    this.title = "The title of courses page";
                    this.courses = courseService.getCourses();
                }
                CoursesComponents = __decorate([
                    core_1.Component({
                        selector: 'courses',
            ...
            exports_1("CoursesComponents", CoursesComponents);
        }
    }
});
